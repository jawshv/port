    ...
    Sections: [
      {
        ...
        offsite: 'https://hivelighting.com/',
        offsitewords: 'Hive Lighting',
        words2: 'I used established iconography to create a consistent brand identity. Responsibilities included producing all print, web, photo, and video marketing assets. I’ve highlighted a few select projects below.',
      },
      {
        header: 'Graphic Standards',
      ...
      {
        header: 'PRINT',
        words: 'With the core product line quintupling, there was a special need for consistency. We wanted a visual language that conveyed the existence of a “C-Series Family” while also making differences between lights obvious.',
      },
      {
      ...
      {
        header: 'Marketing',
        words: 'One of the challenges we faced in marketing the C-Series at Hive Lighting was the universal flexibility of the product. A core selling point was huge versatility in optics, color, mounting. With limited resources, our solution was creating a regular trickle of videos showing off key product features. These largely took two shapes; first being quick youtube “how-to” product tutorials showcasing features largely meant for current customers, the second being flashier animations for Instagram promotion.  Created with',
        offsite: 'http://rollinleonard.com/',
        offsitewords: 'Rollin Leonard.',
      },
      {
        video: 'https://player.vimeo.com/video/311613042?loop=1&color=ffffff&title=0&byline=0&portrait=0',
        caption: 'Promoted Instagram Ad',
      },
      {
        video: 'https://player.vimeo.com/video/348075280?loop=1&color=ffffff&title=0&byline=0&portrait=0',
...
///////////////
  {
    ...
    Sections: [
      {
        words: 'The Duo was a collaborative music video production team with',
        offsite: 'https://www.anissaamalia.com/',
        offsitewords: 'Anissa Amalia.',
      },
      {
        words: 'A full archive of all music videos can be found on',
        offsite: 'https://vimeo.com/anissaxjosh',
        offsitewords: 'vimeo.',
        words2: 'Best experienced in fullsceen and headphones.',
      },
      {
        video: 'https://player.vimeo.com/video/216630719?loop=1&color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/195345965?color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/201996728?color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/195345055?color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/217065781?color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/201252209?color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/195818837?color=ffffff&title=0&byline=0&portrait=0',
      },
      {
        video: 'https://player.vimeo.com/video/195351011?color=ffffff&title=0&byline=0&portrait=0',
      },
    ]
  },
///////////////
  {
    ...
    {
      offsite: 'http://noparkinghere.com/',
      offsitewords: 'Noparkinghere.com',
      words2: 'is a web essay looking at how current parking legislation in Los Angeles runs counter to LA’s goals re: housing crisis and the environment.',
    },
    {
...
///////////////
  {
    ...
    Sections: [
    {
      words: 'AAT was a collaborative project created with ',
      offsite: 'https://cargocollective.com/maimoonarahim',
      offsitewords: 'Maimoona Rahim',
